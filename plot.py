...
if fl is not None:
    ...
    os.chdir(r"C:\Users\hp\OneDrive\Documents\5th SEM\newwww\merged_files")
    df = pd.read_csv("merged_crack.csv")

st.sidebar.header("Choose your filters:")

sensor_names = set(col.split('-')[0] for col in df.columns if col != 'Date Time (UTC+08:00)')
...
filtered_data['Date Time (UTC+08:00)'] = pd.to_datetime(filtered_data['Date Time (UTC+08:00)'])
...
df1 = pd.read_csv("merged_tilt.csv")

st.sidebar.header("Choose your filters:")

tilt_names = set(col.split('-')[0] for col in df1.columns if col != 'Date Time (UTC+08:00)')
